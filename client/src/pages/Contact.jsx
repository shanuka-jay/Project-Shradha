  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Optional: hide success box after few seconds
        setTimeout(() => {
          setSubmitted(false)
        }, 4000)
      ...
      >
        ...
        <div className="banner-content">
          ...
          <h1 className="banner-title">
            We'd Love to
            <br />
            <span className="banner-title-italic">
              Hear From You
            </span>
          </h1>

          <p className="banner-desc">
            Whether you want to add a temple,
            make a correction, or simply
            <br />
            connect with the Saddha.org community —
      ...
      <div className="contact-main">
        ...
        <div className="contact-info">
          ...
          <div className="info-header">
            <span className="gold-dash">—</span>
            <span className="info-subtitle-main">
              CONTACT INFORMATION
            </span>
          </div>
          ...
          <div className="location-image-card">
            ...
            <div className="location-img-wrapper">
              <img
                src={viharaImage}
                alt="Washington Buddhist Vihara"
              ...
              >
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="Temple name subject to inquiry"
                  />
                </div>
